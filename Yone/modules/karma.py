...
from Yone import OWNER_ID, pbot
from Yone.utils.admins import can_change_info
from Yone.utils.errors import capture_err
from Yone.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|yone|thank you|gud|thankyou|love|pro)$"
