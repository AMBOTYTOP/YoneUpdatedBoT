...
@yone.on_message(filters.command(["short"]))
...
@yone.on_message(filters.command(["unshort"]))
...
# yone.add_handler(MessageHandler(short_urls))
# yone.add_handler(MessageHandler(unshort))
__help__ = """
