import requests
from .. import pbot as yone,BOT_NAME,BOT_USERNAME
import time
from pyrogram.enums import ChatAction, ParseMode
from pyrogram import filters
@yone.on_message(filters.command(["password"]))
...
@yone.on_message(filters.command(["morseencode"]))
async def morse_en(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@yone.on_message(filters.command("morsedecode"))
async def morse_de(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@yone.on_message(filters.command(["encode"]))
async def base_en(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@yone.on_message(filters.command(["decode"]))
