...
@yone.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        geolocator = Nominatim(user_agent="legend-yone")
#         zoom=[0-18]
...
@yone.on_message(filters.command(["distance"]))
...
# yone.add_handler(MessageHandler(gps))     
# yone.add_handler(MessageHandler(distance))
