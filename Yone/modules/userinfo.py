...
from Yone.modules.alive import yone
import Yone.modules.sql.userinfo_sql as sql
from Yone import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Yone.__main__ import STATS, TOKEN, USER_INFO
from Yone.modules.disable import DisableAbleCommandHandler
from Yone.modules.helper_funcs.chat_status import sudo_plus
from Yone.modules.helper_funcs.extraction import extract_user
from Yone.modules.sql.global_bans_sql import is_user_gbanned
from Yone.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/yonebotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/yonebotzone/90"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/yonebotzone/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/yonebotzone/90"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/yonebotzone/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
