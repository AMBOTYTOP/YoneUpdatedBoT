...
# from Yone.modules.sql import warns_sql as warnssql
import Yone.modules.sql.blacklist_sql as blacklistsql

# from Yone.modules.sql import cust_filters_sql as filtersql
# import Yone.modules.sql.welcome_sql as welcsql
import Yone.modules.sql.locks_sql as locksql
import Yone.modules.sql.notes_sql as sql

# from Yone.modules.rules import get_rules
import Yone.modules.sql.rules_sql as rulessql
from Yone import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from Yone.__main__ import DATA_IMPORT
from Yone.modules.connection import connected
...
from Yone.modules.sql import disable_sql as disabledsql
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                f"An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @AM_YTSUPPORT"
            )
...
def export_data(update, context):
    ...
    with open("Yone{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Yone{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Yone-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Yone{}.backup".format(chat_id))  # Cleaning file
