...
import Yone.modules.no_sql.users_db as sql
from Yone import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
...
from Yone.modules import ALL_MODULES
from Yone.modules.helper_funcs.chat_status import is_user_admin
from Yone.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="🏡", callback_data="yone_back"),
        InlineKeyboardButton(text="🛡️", callback_data="yone_"),
        InlineKeyboardButton(text="💳", callback_data="source_"),
        InlineKeyboardButton(text="🧑‍💻", url=f"tg://user?id={SULTAN}"),
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @New_AMBOT ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @AM_YTSUPPORT ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Yone.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgQAAx0CbcjZvwACbP5lqhPGNJtpWe0wWWmGD0jcgrqkqAACLwwAAuqTAVKXwqXcqn7CKDQE")
            x.delete()
        ...
        if mod_match:
            ...
            query.message.edit_caption(text,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="yone_support")]]
                ),
            )
...
def yone_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "yone_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ", callback_data="yone_support"
                        ),
                        InlineKeyboardButton(
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                      ...
                      [
                        InlineKeyboardButton(
                            text="💌 ᴄʜᴀᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/{CHAT}"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            text="🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ", url=f"tg://user?id={SULTAN}"
                        ),
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url="https://github.com/AbhiModszYT?tab=repositories"
                        ),
                    ],
                    [
...
def Yone_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="• Hᴏᴍᴇ •", callback_data="yone_back")]
                ]
            ),
        )
...
◽️ /staff ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="yone_support")
                    ]
                ]
            ),
            )
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="yone_support")
                    ]
                ]
            ),
            )  
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/AbhiModszYT?tab=repositories)


{BOT_NAME} ɪs © 2023 - 2024 | [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="sᴏᴜʀᴄᴇ", url="https://github.com/AbhiModszYT?tab=repositories")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="yone_back"),
        InlineKeyboardButton(text="🛡️", callback_data="yone_"),
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="yone_support")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="yone_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5360305806:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/AbhiModszYT?tab=repositories)"
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/Yone_Robot?startgroup=true"
                            )
                       ]
                ]
                     )
...
""",reply_markup=x,
    ...
    Yone_main_handler = CallbackQueryHandler(
        Yone_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(Yone_main_handler)
